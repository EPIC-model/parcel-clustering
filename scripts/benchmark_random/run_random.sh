...
# 1 node to 8 nodes
run_jobs "submit_random.sh" "cray" 1 5 256 512 80 160 7 10 "false"

# 2 nodes to 32 nodes
run_jobs "submit_random.sh" "cray" 1 5 512 512 160 160 8 12 "false"

# 8 nodes to 128 nodes
run_jobs "submit_random.sh" "cray" 1 5 1024 1024 320 320 10 14 "false"
